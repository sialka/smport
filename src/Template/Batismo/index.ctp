...
<div class="container-row">
    <div class="col-12">
        ...
        <div class="col-12 p-0 mb-2 mobile-hide">
            ...
            <a class="btn btn-success no-radius" href="/Batismo/add">
                                            ...
                                            <td class="text-center px-3">
                                                <div class="dropdown d-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right -py-2 -m-0" aria-labelledby="acoesListar">
                                                        <a class="dropdown-item"  href="/Batismo/view/<?= $local->id;?>">
                                                            <i class="fa fa-search text-primary"></i>
                                                            Visualizar
                                                        </a>
                                                        <a class="dropdown-item" href="/Batismo/edit/<?= $local->id;?>"
                                                            data-confirm = "Tem certeza que deseja editar o Batismo?">
                                                            <i class="fa fa-pencil-alt text-success"></i>
                                                            Editar
                                                        </a>
                                                        <a class="dropdown-item" href="/Batismo/delete/<?= $local->id;?>"
                                                            data-confirm = "Tem certeza que deseja excluir o Batismo?">

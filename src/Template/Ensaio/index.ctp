                                ...
                                <tbody class="tdMiddleAlign">
                                    <?php foreach ($ensaio as $local): ?>
                                        <tr class="vAlignMiddle">
                                            ...
                                            <td class="text-left px-3"><?= h($utils['semana_id_longo'][$local->dia_semana]); ?></td>
                                            <td class="text-left px-3"><?= h($aevOptions['hora'][$local->horario_id]); ?></td>
                                            <td class="text-left px-3"><?= h($aevOptions['semana'][$local->semana]); ?></td>
                                            ...
                                            <td class="text-center px-3">
                                                <div class="dropdown d-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right -py-2 -m-0" aria-labelledby="acoesListar">
                                                        <a class="dropdown-item"  href="/Ensaio/view/<?= $local->id;?>">
                                                            <i class="fa fa-search text-primary"></i>
                                                            Visualizar
                                                        </a>
                                                        <a class="dropdown-item" href="/Ensaio/edit/<?= $local->id;?>"
                                                            data-confirm = "Tem certeza que deseja editar o Ensaio?">
                                                            <i class="fa fa-pencil-alt text-success"></i>
                                                            Editar
                                                        </a>
                                                        <a class="dropdown-item" href="/Ensaio/delete/<?= $local->id;?>"

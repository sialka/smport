...
<div class="container-row">
    <div class="col-12">
        ...
        <div class="col-12 p-0 mb-2 mobile-hide">
            ...
            <a class="btn btn-success no-radius" href="/Ordenacao/add">
                                            ...
                                            <td class="text-left px-3">
                                                <div class="dropdown d-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right -py-2 -m-0" aria-labelledby="acoesListar">
                                                        <a class="dropdown-item"  href="/Ordenacao/view/<?= $local->id;?>">
                                                            <i class="fa fa-search text-primary"></i>
                                                            Visualizar
                                                        </a>
                                                        <a class="dropdown-item" href="/Ordenacao/edit/<?= $local->id;?>"
                                                            data-confirm = "Tem certeza que deseja editar a Ordenação?">
                                                            <i class="fa fa-pencil-alt text-success"></i>
                                                            Editar
                                                        </a>
                                                        <a class="dropdown-item" href="/Ordenacao/delete/<?= $local->id;?>"
                                                            data-confirm = "Tem certeza que deseja excluir a Ordenação?">

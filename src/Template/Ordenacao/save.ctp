...
<div class="container-row mt-2">
    <div class="col-xxl-4 offset-xxl-4 col-xl-6 offset-xl-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-xs-12">
        ...
        <?= $this->Form->create($ordenacao, array('class' => 'form-horizontal needs-validation', 'type' => 'post', 'novalidate')) ?>
        ...
        <div class="card shadow border-1 no-radius mb-4 m-1">
                ...
                <div class="row">
                    <div class="form-group col-lg-3 col-md-6 col-sm-6 col-sx-6">
                        ...
                        if ($mode == "add") {
                            ...
                            echo __("<label class='form-control disabled no-radius text-center'><strong>{$ordenacao->id}</strong></label>");
                        }
                        ?>
                    </div>
                </div>
                        ...
                        <div class='input-group input-group-sm'>
                            ...
                            $this->Form->input('data',
                                    array(
                                        ...
                                        'div'         => false,
                                        'label'       => false,
                                        'value'       => strlen($ordenacao->data) > 0 ? $ordenacao->data->format('d/m/Y') : $hoje,
                                        'required'
                                    )
                            )
                            ?>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            $this->Form->input('created',
                                    array(
                                        ...
                                        'div' => false,
                                        'label' => false,
                                        'value' => strlen($ordenacao->created) > 0 ? $ordenacao->created->format('d/m/Y H:i:s') : "00/00/0000 00:00:00",
                                    )
                            )
                            ?>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            $this->Form->input('modified',
                                    array(
                                        ...
                                        'div' => false,
                                        'label' => false,
                                        'value' => strlen($ordenacao->modified) > 0 ? $ordenacao->modified->format('d/m/Y H:i:s') : "00/00/0000 00:00:00",
                                    )
                            )
                            ?>
                        </div>
            ...
            <div class="card-footer bg-light">
                <div class="text-end">
                    ...
                    <a class="btn btn-light no-radius no-link" href="/Ordenacao/index">

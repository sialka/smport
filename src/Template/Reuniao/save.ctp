        ...
        <div class="card shadow border-1 no-radius mb-4">
                ...
                <div class="row">
                    <div class="form-group col-lg-3 col-md-6 col-sm-6 col-sx-6">
                        ...
                        if ($mode == "add") {
                            ...
                            echo __("<label class='form-control disabled no-radius text-center'><strong>{$reuniao->id}</strong></label>");
                        }
                        ?>
                    </div>
                </div>
                        ...
                        <div class='input-group'>
                            ...
                            $this->Form->input('data',
                                    array(
                                        ...
                                        'div'         => false,
                                        'label'       => false,
                                        'value'       => strlen($reuniao->data) > 0 ? $reuniao->data->format('d/m/Y') : $hoje,
                                        'required'
                                    )
                            )
                            ?>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            $this->Form->input('created',
                                    array(
                                        ...
                                        'div' => false,
                                        'label' => false,
                                        'value' => strlen($reuniao->created) > 0 ? $reuniao->created->format('d/m/Y H:i:s') : "00/00/0000 00:00:00",
                                    )
                            )
                            ?>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            $this->Form->input('modified',
                                    array(
                                        ...
                                        'div' => false,
                                        'label' => false,
                                        'value' => strlen($reuniao->modified) > 0 ? $reuniao->modified->format('d/m/Y H:i:s') : "00/00/0000 00:00:00",
                                    )
                            )
                            ?>
                        </div>
            ...
            <div class="card-footer bg-light">
                <div class="text-end">
                    ...
                    <a class="btn btn-light no-radius no-link" href="/Reuniao/index">
